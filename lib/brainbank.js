...
export const LOGIC = [
  ...
  { q: "Mary's father has five daughters: Nana, Nene, Nini, Nono and…", o: ['Nunu', 'Mary', 'Nana', 'Cannot say'], a: 1 },
  { q: 'How many months of the year have 28 days?', o: ['1', '2', '6', 'All 12'], a: 3 },
  { q: 'Divide 30 by half and add 10. What do you get?', o: ['25', '40', '70', '55'], a: 2 },
  { q: 'A farmer has 17 sheep. All but 9 run away. How many are left?', o: ['8', '9', '17', '0'], a: 1 },
  { q: 'Two fathers and two sons ate exactly 3 eggs, one each. How?', o: ['One shared', 'They were grandfather, father and son', 'One egg was double', 'Impossible'], a: 1 },
  { q: 'A plane crashes exactly on the India–Nepal border. Where are the survivors buried?', o: ['India', 'Nepal', 'Split between both', 'Survivors are not buried'], a: 3 },
  { q: 'Before Mount Everest was discovered, what was the highest mountain on Earth?', o: ['K2', 'Kanchenjunga', 'Still Mount Everest', 'None'], a: 2 },
  { q: 'A doctor gives you 3 pills: take one every half hour. How long until they are finished?', o: ['90 minutes', '60 minutes', '30 minutes', '120 minutes'], a: 1 },
];
...
export const WORDS = [
  ...
  { w: 'GRAVITY', h: 'The force that keeps you on the ground', c: 'Physics' },
  { w: 'ECLIPSE', h: 'One celestial body hiding another', c: 'Astronomy' },
  { w: 'MONSOON', h: 'Seasonal winds that bring India its rains', c: 'Climate' },
  { w: 'HORIZON', h: 'Where the sky appears to meet the earth', c: 'Geography' },
  { w: 'CRYSTAL', h: 'Solid with an ordered, repeating structure', c: 'Chemistry' },
  { w: 'VOLCANO', h: 'A mountain that erupts molten rock', c: 'Geology' },
  { w: 'EQUATOR', h: 'The imaginary line at zero degrees latitude', c: 'Geography' },
  { w: 'NEURON', h: 'The nerve cell that carries your thoughts', c: 'Neuroscience' },
  { w: 'ORBIT', h: 'The path of one body around another', c: 'Astronomy' },
  { w: 'PIXEL', h: 'The smallest dot in a digital image', c: 'Technology' },
  { w: 'ENZYME', h: 'A protein that speeds up body chemistry', c: 'Biology' },
  { w: 'GLACIER', h: 'A slow-moving river of ice', c: 'Geology' },
  { w: 'ISLAND', h: 'Land surrounded by water on all sides', c: 'Geography' },
];
...
export const GEO = [
  ...
  { q: 'The longest river in Africa is the…', o: ['Congo', 'Niger', 'Nile', 'Zambezi'], a: 2 },
  { q: 'Mount Everest lies on the border of Nepal and…', o: ['India', 'China (Tibet)', 'Bhutan', 'Pakistan'], a: 1 },
  { q: 'The largest hot desert in the world is the…', o: ['Gobi', 'Thar', 'Sahara', 'Kalahari'], a: 2 },
  { q: 'The capital of Australia is…', o: ['Sydney', 'Melbourne', 'Canberra', 'Perth'], a: 2 },
  { q: '"Land of the Rising Sun" refers to…', o: ['China', 'Japan', 'Thailand', 'South Korea'], a: 1 },
  { q: "India's southernmost point, Indira Point, is located in…", o: ['Kanyakumari', 'The Andaman & Nicobar Islands', 'Lakshadweep', 'Rameswaram'], a: 1 },
  { q: 'The Thar Desert lies mostly in which Indian state?', o: ['Gujarat', 'Rajasthan', 'Punjab', 'Haryana'], a: 1 },
  { q: 'The Sundarbans mangrove forest is famous for its…', o: ['Lions', 'Royal Bengal tigers', 'Rhinos', 'Snow leopards'], a: 1 },
];
...
export const GK = [
  ...
  { q: 'The chemical formula of water is…', o: ['CO2', 'H2O', 'O2', 'NaCl'], a: 1 },
  { q: 'A light year measures…', o: ['Time', 'Distance', 'Brightness', 'Speed'], a: 1 },
  { q: 'Which planet is called the Red Planet?', o: ['Venus', 'Jupiter', 'Mars', 'Mercury'], a: 2 },
  { q: 'Plants make their food by a process called…', o: ['Respiration', 'Photosynthesis', 'Digestion', 'Fermentation'], a: 1 },
  { q: 'The human heart has how many chambers?', o: ['2', '3', '4', '6'], a: 2 },
  { q: 'The "brain" of a computer is the…', o: ['RAM', 'CPU', 'Monitor', 'Keyboard'], a: 1 },
  { q: 'The SI unit of force is the…', o: ['Joule', 'Watt', 'Newton', 'Pascal'], a: 2 },
  { q: 'ISRO is headquartered in…', o: ['Mumbai', 'New Delhi', 'Bengaluru', 'Hyderabad'], a: 2 },
  { q: 'The largest planet in our solar system is…', o: ['Saturn', 'Jupiter', 'Neptune', 'Earth'], a: 1 },
  { q: 'The telephone was invented by…', o: ['Thomas Edison', 'Alexander Graham Bell', 'Nikola Tesla', 'Marconi'], a: 1 },
];
...
export const RIDDLES = [
  ...
  { q: 'What comes once in a minute, twice in a moment, but never in a thousand years?', o: ['Time', 'The letter M', 'Luck', 'A second'], a: 1 },
  { q: 'I have keys but open no locks, I have space but no room. What am I?', o: ['A map', 'A keyboard', 'A piano', 'A phone'], a: 1 },
  { q: 'I am full of holes but I still hold water. What am I?', o: ['A net', 'A sponge', 'A bucket', 'A cloud'], a: 1 },
  { q: 'What goes up but never comes down?', o: ['A balloon', 'Your age', 'Smoke', 'Prices'], a: 1 },
  { q: 'It belongs to you, but other people use it far more than you do. What is it?', o: ['Your phone', 'Your name', 'Your shadow', 'Your time'], a: 1 },
  { q: 'What has a neck but no head?', o: ['A shirt', 'A bottle', 'A guitar', 'All of these'], a: 3 },
];
